...
hist(x11, main = "Sebaran Percontohan Normal 10 Sampel"); mean(x11); var(x11)
```
...
hist(x12, main = "Sebaran Percontohan Normal 30 Sampel"); mean(x12); var(x12)
```
...
hist(x13, main = "Sebaran Percontohan Normal 100 Sampel"); mean(x13); var(x13)
```
...
hist(x21, main = "Sebaran Percontohan Eksponensial 10 Sampel"); mean(x21); var(x21)
```
...
hist(x22, main = "Sebaran Percontohan Eksponensial 30 Sampel") ; mean(x22); var(x22)
```
...
hist(x23, main = "Sebaran Percontohan Eksponensial 100 Sampel"); mean(x23); var(x23)
```
...
hist(x31, main = "Sebaran Percontohan Seragam 10 Sampel"); mean(x31); var(x31)
```
...
hist(x32, main = "Sebaran Percontohan Seragam 30 Sampel"); mean(x32); var(x32)
```
...
hist(x33, main = "Sebaran Percontohan Seragam 100 Sampel"); mean(x33); var(x33)
```
