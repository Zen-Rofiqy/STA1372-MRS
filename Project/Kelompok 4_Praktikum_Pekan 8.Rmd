...
par(mfrow = c(1, 3))
hist(norm_samples[[1]], main = "Histogram Normal n=2", 
     xlab = "Nilai", ylab = "Frekuensi", col = "#d9eacb")
hist(norm_samples[[2]], main = "Histogram Normal n=5", 
     xlab = "Nilai", ylab = "Frekuensi", col = "#b4e69e")
hist(norm_samples[[3]], main = "Histogram Normal n=25", 
...
par(mfrow = c(1, 3))
hist(unif_samples[[1]], main = "Histogram Seragam n=2", 
     xlab = "Nilai", ylab = "Frekuensi", col = "#c8daf0")
hist(unif_samples[[2]], main = "Histogram Seragam n=5", 
     xlab = "Nilai", ylab = "Frekuensi", col = "#a2c6eb")
hist(unif_samples[[3]], main = "Histogram Seragam n=25", 
...
par(mfrow = c(1, 3))
hist(exp_samples[[1]], main = "Histogram Eksponensial n=2", 
     xlab = "Nilai", ylab = "Frekuensi", col = "#E4B3BA")
hist(exp_samples[[2]], main = "Histogram Eksponensial n=5", 
     xlab = "Nilai", ylab = "Frekuensi", col = "#DE7C8A")
hist(exp_samples[[3]], main = "Histogram Eksponensial n=25", 
...
```{r}
# Inisialisasi ukuran sampel yang diinginkan
sample_sizes <- c(2, 5, 25)

# Inisialisasi list untuk menyimpan histogram dari setiap sampel
sample_histograms <- list()

# Inisialisasi list untuk menyimpan rata-rata dari masing-masing sampel
norm_means <- numeric(length(sample_sizes))

# Loop untuk menghasilkan sampel dan histogram dari masing-masing sampel
for (i in seq_along(sample_sizes)) {
  samp <- rnorm(sample_sizes[i])  # Generate sampel
  sample_histograms[[i]] <- hist(samp, plot = FALSE)  # Buat histogram untuk sampel dan simpan dalam list
  norm_means[i] <- mean(samp)  # Hitung rata-rata sampel
}
...
# Tampilkan histogram dari masing-masing sampel
par(mfrow = c(1, length(sample_sizes)))  # Atur layout grafik menjadi satu baris
for (i in seq_along(sample_sizes)) {
  plot(sample_histograms[[i]], main = paste("Histogram Sample Size", sample_sizes[i]), col = "#8DC16D")
}
```
