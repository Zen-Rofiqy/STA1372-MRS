...
hist(mixed_data1[[2]], main = "Sebaran Campuran 2\nUkuran sample (n=12)", 
     xlab = "Nilai", ylab = "Frekuensi", col = "#d5bbf3")
hist(mixed_data1[[3]], main = "Sebaran Campuran 3\nUkuran sample (n=20)", 
     xlab = "Nilai", ylab = "Frekuensi", col = "#9d48c7")
hist(mixed_data1[[4]], main = "Sebaran Campuran 4\nUkuran sample (n=60)", 
     xlab = "Nilai", ylab = "Frekuensi", col = "#792b9a")
hist(mixed_data1[[5]], main = "Sebaran Campuran 5\nUkuran sample (n=100)", 
...
par(mfrow = c(1, 5))
hist(mixed_data2[[1]], main = "Sebaran Campuran 1\nUkuran sample (n=4)", 
     xlab = "Nilai", ylab = "Frekuensi", col = "#fae7fd")
hist(mixed_data2[[2]], main = "Sebaran Campuran 2\nUkuran sample (n=12)", 
     xlab = "Nilai", ylab = "Frekuensi", col = "#eb91f2")
hist(mixed_data2[[3]], main = "Sebaran Campuran 3\nUkuran sample (n=20)", 
     xlab = "Nilai", ylab = "Frekuensi", col = "#e44cb5")
hist(mixed_data2[[4]], main = "Sebaran Campuran 4\nUkuran sample (n=60)", 
     xlab = "Nilai", ylab = "Frekuensi", col = "#96336c")
hist(mixed_data2[[5]], main = "Sebaran Campuran 5\nUkuran sample (n=100)", 
