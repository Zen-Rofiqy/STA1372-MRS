...
norm_data <- lapply(sample_sizes, function(n) matrix(rnorm(n*k, mean = 0, sd = 1), k))

par(mfrow = c(1, 5))
hist(norm_data[[1]], main = "Sebaran Normal\nUkuran sample (n=4)", 
     xlab = "Nilai", ylab = "Frekuensi", col = "#e3f4f1")
hist(norm_data[[2]], main = "Sebaran Normal\nUkuran sample (n=12)", 
     xlab = "Nilai", ylab = "Frekuensi", col = "#a9ded7")
hist(norm_data[[3]], main = "Sebaran Normal\nUkuran sample (n=20)", 
     xlab = "Nilai", ylab = "Frekuensi", col = "#6ec1c1")
hist(norm_data[[4]], main = "Sebaran Normal\nUkuran sample (n=60)", 
     xlab = "Nilai", ylab = "Frekuensi", col = "#357a87")
hist(norm_data[[5]], main = "Sebaran Normal\nUkuran sample (n=100)", 
...
```{r fig.height=6.5, fig.width=30, dpi=300}
set.seed(361)
mix_data_1 <- lapply(seq_along(sample_sizes), function(i) {
  n <- sample_sizes[i]
  norm_part <- matrix(rnorm(n*k/2, mean = 0, sd = 1), k/2)
  chisq_part <- matrix(rchisq(n *k /2, df =5), k /2)
  rbind(norm_part, chisq_part)
})

par(mfrow = c(1, 5))
hist(mix_data_1[[1]], main = "Sebaran Campuran 1\nUkuran sample (n=4)", 
     xlab = "Nilai", ylab = "Frekuensi", col = "#eae1f8")
hist(mix_data_1[[2]], main = "Sebaran Campuran 1\nUkuran sample (n=12)", 
     xlab = "Nilai", ylab = "Frekuensi", col = "#d5bbf3")
hist(mix_data_1[[3]], main = "Sebaran Campuran 1\nUkuran sample (n=20)", 
     xlab = "Nilai", ylab = "Frekuensi", col = "#9d48c7")
hist(mix_data_1[[4]], main = "Sebaran Campuran 1\nUkuran sample (n=60)", 
     xlab = "Nilai", ylab = "Frekuensi", col = "#792b9a")
hist(mix_data_1[[5]], main = "Sebaran Campuran 1\nUkuran sample (n=100)", 
...
```{r fig.height=6.5, fig.width=30, dpi=300}
set.seed(361)
mix_data_2 <- lapply(sample_sizes, function(n) {
  chisq_a <- matrix(rchisq(n*k/2, df = 3), k/2)
  chisq_b <- matrix(rchisq(n*k/2, df = 8), k/2)
  rbind(chisq_a, chisq_b)
})

par(mfrow = c(1, 5))
hist(mix_data_2[[1]], 
     main = "Sebaran Campuran 2\nUkuran sample (n=4)", 
...
```{r fig.height=6.5, fig.width=30, dpi=300}
set.seed(361)
mix_data_3 <- lapply(seq_along(sample_sizes), function(i) {
  n <-  sample_sizes[i]
  chisq_a <- matrix(rchisq(n*k/4, df = 3), k/4)
  chisq_b <- matrix(rchisq(n*k/4, df = 8), k/4)
  norm_a <- matrix(rnorm(n*k/4, mean = 0, sd = 1), k/4)
  norm_b <- matrix(rnorm(n*k/4, mean = 2, sd = 1.5), k/4)
  rbind(chisq_a, chisq_b, norm_a, norm_b)
})

par(mfrow = c(1, 5))
hist(mix_data_3[[1]], 
     main = "Sebaran Campuran 3\nUkuran sample (n=4)", 
...
```{r fig.height=6.5, fig.width=30, dpi=300}
norm_data_means <- dist_mean(sample_sizes, norm_data)

par(mfrow = c(1, 5))
qqnorm(norm_data_means[[1]], main = "QQ-Plot Normal\nUkuran Sample (n=4)", col = "#e3f4f1", lwd = 7,
       xlab = "Theoretical Quantiles", ylab = "Sample Quantiles")
qqline(norm_data_means[[1]], col = "black", lwd=2)

qqnorm(norm_data_means[[2]], main = "QQ-Plot Normal\nUkuran Sample (n=12)", col = "#a9ded7", lwd = 7,
       xlab = "Theoretical Quantiles", ylab = "Sample Quantiles")
qqline(norm_data_means[[2]], col = "black", lwd=2)

qqnorm(norm_data_means[[3]], main = "QQ-Plot Normal\nUkuran Sample (n=20)", col = "#6ec1c1", lwd = 7,
       xlab = "Theoretical Quantiles", ylab = "Sample Quantiles")
qqline(norm_data_means[[3]], col = "black", lwd=2)

qqnorm(norm_data_means[[4]], main = "QQ-Plot Normal\nUkuran Sample (n=60)", col = "#357a87", lwd = 7,
       xlab = "Theoretical Quantiles", ylab = "Sample Quantiles")
qqline(norm_data_means[[4]], col = "black", lwd=2)

qqnorm(norm_data_means[[5]], main = "QQ-Plot Normal\nUkuran Sample (n=100)", col = "#0f2c3a", lwd = 7,
       xlab = "Theoretical Quantiles", ylab = "Sample Quantiles")
qqline(norm_data_means[[5]], col = "black", lwd=2)
```
...
sample_sizes4 <- c(100, 200, 300, 400, 500)

mix_data_4 <- lapply(seq_along(sample_sizes4), function(i) {
  n <- sample_sizes4[i]
  norm_part <- matrix(rnorm(n*k/2, mean = 1, sd = 1), k/2)
  chisq_part <- matrix(rchisq(n *k /2, df =5), k /2)
  rbind(norm_part, chisq_part)
})

par(mfrow = c(1, 5))
hist(apply(mix_data_4[[1]], 1, mean))
hist(apply(mix_data_4[[2]], 1, mean))
hist(apply(mix_data_4[[3]], 1, mean))
hist(apply(mix_data_4[[4]], 1, mean))
hist(apply(mix_data_4[[5]], 1, mean))
```
...
mix_data_1_means <- dist_mean(sample_sizes, mix_data_1)

par(mfrow = c(1, 5))
qqnorm(mix_data_1_means[[1]], main = "QQ-Plot Campuran 1\nUkuran Sample (n=4)", col = "#eae1f8", lwd = 7,
       xlab = "Theoretical Quantiles", ylab = "Sample Quantiles")
qqline(mix_data_1_means[[1]], col = "black", lwd=2)

qqnorm(mix_data_1_means[[2]], main = "QQ-Plot Campuran 1\nUkuran Sample (n=12)", col = "#d5bbf3", lwd = 7,
       xlab = "Theoretical Quantiles", ylab = "Sample Quantiles")
qqline(mix_data_1_means[[2]], col = "black", lwd=2)

qqnorm(mix_data_1_means[[3]], main = "QQ-Plot Campuran 1\nUkuran Sample (n=20)", col = "#9d48c7", lwd = 7,
       xlab = "Theoretical Quantiles", ylab = "Sample Quantiles")
qqline(mix_data_1_means[[3]], col = "black", lwd=2)

qqnorm(mix_data_1_means[[4]], main = "QQ-Plot Campuran 1\nUkuran Sample (n=60)", col = "#792b9a", lwd = 7,
       xlab = "Theoretical Quantiles", ylab = "Sample Quantiles")
qqline(mix_data_1_means[[4]], col = "black", lwd=2)

qqnorm(mix_data_1_means[[5]], main = "QQ-Plot Campuran 1\nUkuran Sample (n=100)", col = "#48185b", lwd = 7,
       xlab = "Theoretical Quantiles", ylab = "Sample Quantiles")
qqline(mix_data_1_means[[5]], col = "black", lwd=2)
```

### Campuran 2

```{r fig.height=6.5, fig.width=30, dpi=300}
mix_data_2_means <- dist_mean(sample_sizes, mix_data_2)

par(mfrow = c(1, 5))
qqnorm(mix_data_2_means[[1]], main = "QQ-Plot Campuran 2\nUkuran Sample (n=4)", col = "#fae7fd", lwd = 7,
       xlab = "Theoretical Quantiles", ylab = "Sample Quantiles")
qqline(mix_data_2_means[[1]], col = "black", lwd=2)

qqnorm(mix_data_2_means[[2]], main = "QQ-Plot Campuran 2\nUkuran Sample (n=12)", col = "#eb91f2", lwd = 7,
       xlab = "Theoretical Quantiles", ylab = "Sample Quantiles")
qqline(mix_data_2_means[[2]], col = "black", lwd=2)

qqnorm(mix_data_2_means[[3]], main = "QQ-Plot Campuran 2\nUkuran Sample (n=20)", col = "#e44cb5", lwd = 7,
       xlab = "Theoretical Quantiles", ylab = "Sample Quantiles")
qqline(mix_data_2_means[[3]], col = "black", lwd=2)

qqnorm(mix_data_2_means[[4]], main = "QQ-Plot Campuran 2\nUkuran Sample (n=60)", col = "#96336c", lwd = 7,
       xlab = "Theoretical Quantiles", ylab = "Sample Quantiles")
qqline(mix_data_2_means[[4]], col = "black", lwd=2)

qqnorm(mix_data_2_means[[5]], main = "QQ-Plot Campuran 2\nUkuran Sample (n=100)", col = "#61283f", lwd = 7,
       xlab = "Theoretical Quantiles", ylab = "Sample Quantiles")
qqline(mix_data_2_means[[5]], col = "black", lwd=2)
```

### Campuran 3 

```{r fig.height=6.5, fig.width=30, dpi=300}
mix_data_3_means <- dist_mean(sample_sizes, mix_data_3)

par(mfrow = c(1, 5))
qqnorm(mix_data_3_means[[1]], main = "QQ-Plot Campuran 3\nUkuran Sample (n=4)", col = "#f5d0bf", lwd = 7,
       xlab = "Theoretical Quantiles", ylab = "Sample Quantiles")
qqline(mix_data_3_means[[1]], col = "black", lwd=2)

qqnorm(mix_data_3_means[[2]], main = "QQ-Plot Campuran 3\nUkuran Sample (n=12)", col = "#e9865b", lwd = 7,
       xlab = "Theoretical Quantiles", ylab = "Sample Quantiles")
qqline(mix_data_3_means[[2]], col = "black", lwd=2)

qqnorm(mix_data_3_means[[3]], main = "QQ-Plot Campuran 3\nUkuran Sample (n=20)", col = "#ce572b", lwd = 7,
       xlab = "Theoretical Quantiles", ylab = "Sample Quantiles")
qqline(mix_data_3_means[[3]], col = "black", lwd=2)

qqnorm(mix_data_3_means[[4]], main = "QQ-Plot Campuran 3\nUkuran Sample (n=60)", col = "#9a3b1a", lwd = 7,
       xlab = "Theoretical Quantiles", ylab = "Sample Quantiles")
qqline(mix_data_3_means[[4]], col = "black", lwd=2)

qqnorm(mix_data_3_means[[5]], main = "QQ-Plot Campuran 3\nUkuran Sample (n=100)", col = "#59230c", lwd = 7,
       xlab = "Theoretical Quantiles", ylab = "Sample Quantiles")
qqline(mix_data_3_means[[5]], col = "black", lwd=2)
```
