...
```{r fig.height=6.5, fig.width=30, dpi=300}
# Data campuran: 50% dari sebaran normal + 50% dari sebaran chi-square
...
```{r fig.height=6.5, fig.width=30, dpi=300}
# Data campuran: 50% sebaran chi-square parameter a + 50% sebaran chi-square parameter b
...
par(mfrow = c(1, 5))
hist(mix_data_2[[1]], 
     main = "Sebaran Campuran 2\n50% Chi-Square df(a) + 50% Chi-Square df(b)\nUkuran sample (n=4)", 
     xlab = "Nilai", ylab = "Frekuensi", col = "#eae1f8")
hist(mix_data_2[[2]], 
     main = "Sebaran Campuran 2\n50% Chi-Square df(a) + 50% Chi-Square df(b)\nUkuran sample (n=12)", 
     xlab = "Nilai", ylab = "Frekuensi", col = "#d5bbf3")
...
```{r}
# Data campuran: 25% sebaran chi-square parameter a + 25% sebaran chi-square parameter b + 25% sebaran normal parameter a + 25% sebaran normal parameter b
mix_data_3 <- lapply(sample_sizes, function(n) {
  chisq_a <- matrix(rchisq(n*k/4, df = 3), n*k/4)
  chisq_b <- matrix(rchisq(n*k/4, df = 8), n*k/4)
  norm_a <- norm_data[[which(sample_sizes == n)]][1:(n*k/4), ]
  norm_b <- matrix(rnorm(n*k/4, mean = 2, sd = 1.5), n*k/4)
...
3.  Buat **histogram** dan **normal qq-plot**
4.  Pada **n berapa** sebaran rataan dari masing-masing data **mulai simeteris** atau **mendekati** sebaran **normal**?
