...
```{r fig.height=3.5*4, fig.width=6*4, dpi=300}
...
# Menentukan tinggi relatif dari setiap baris
rel_heights <- c(rep(2/8, 4), rep(1/8, 7))
plot_grid(plotlist = all_plots, ncol = 8, rel_heights = rel_heights)
```
