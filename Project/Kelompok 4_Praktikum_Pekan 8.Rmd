...
```{r fig.height=3.5*5, fig.width=10*5, dpi=300}
...
for (size in sample_sizes) {
  ...
  plots <- plot_distribution2(norm_samples[[which(sample_sizes == size)]], # Data Awal
                              norm_means[[which(sample_sizes == size)]], # Data Rataan
                              paste0("Distribusi Normal (n=", size, ")"), colors[1]) # Title & Colors
  plots_for_size <- c(plots_for_size, plots)
  
  plots <- plot_distribution2(unif_samples[[which(sample_sizes == size)]], # Data Awal
                             unif_means[[which(sample_sizes == size)]], # Data Rataan
                             paste0("Distribusi Seragam (n=", size, ")"), colors[2]) # Title & Colors
  plots_for_size <- c(plots_for_size, plots)
  
  plots <- plot_distribution2(exp_samples[[which(sample_sizes == size)]], # Data Awal
