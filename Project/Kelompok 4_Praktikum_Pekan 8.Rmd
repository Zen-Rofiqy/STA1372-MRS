...
mix_data_1 <- lapply(seq_along(sample_sizes), function(i) {
  n <- sample_sizes[i]
  norm_part <- norm_data[[i]][1:(k /2), 1:n]
...
```{r fig.height=6.5, fig.width=30, dpi=300}
par(mfrow = c(1, 5))
hist(apply(mix_data_1[[1]], 1, mean))
hist(apply(mix_data_1[[2]], 1, mean))
hist(apply(mix_data_1[[3]], 1, mean))
hist(apply(mix_data_1[[4]], 1, mean))
hist(apply(mix_data_1[[5]], 1, mean))
```
